      ...
      <ModerationDashboard
        ...
        labels={{
          ...
          queueDescriptions: {
            ...
            reports: t('queueDescriptions.reports'),
            messageReports: t('queueDescriptions.messageReports'),
            reviewReports: t('queueDescriptions.reviewReports'),
            appeals: t('queueDescriptions.appeals'),
            operations: t('queueDescriptions.operations')
          },
          preview: t('preview'),
          backToQueue: t('backToQueue'),
          reviewBeforeDecision: t('reviewBeforeDecision'),
          decisionTitle: t('decisionTitle'),
          confirmationMessage: t('confirmationMessage'),
          confirmationCancel: t('confirmationCancel'),
          confirmationContinue: t('confirmationContinue'),
          listingDetails: t('listingDetails'),
          photos: t('photos'),
          photoPrevious: t('photoPrevious'),
          photoNext: t('photoNext'),
          photoCount: t('photoCount'),
          noPhotos: t('noPhotos'),
          attributesTitle: t('attributesTitle'),
